...
<p align="center">
  <picture>
    ...
    <img src="pipeline-light.svg" alt="The research pipeline: interview transcripts become empathy maps and journey maps in parallel, both feed personas, personas feed jobs-to-be-done, which splits into design scenarios and scored AI opportunities, ending in an evidence-based roadmap." width="680">
  </picture>
</p>
